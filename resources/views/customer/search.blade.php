    ...
    <div class="mb-4">
        <form action="{{ route('search') }}" method="GET" class="mb-3">
            <div class="input-group shadow-sm rounded-pill overflow-hidden border p-1 bg-white" style="max-width: 680px; border-color: var(--bm-border) !important;">
                ...
                <input type="text" name="q" class="form-control border-0 shadow-none fs-6"
                       placeholder="Search deals, products, shops, brands..."
                       value="{{ $q }}" autofocus>
        ...
        <div class="d-flex align-items-center justify-content-between flex-wrap gap-2">
            ...
            <div class="d-flex gap-2 align-items-center">
                ...
                <button class="btn btn-sm btn-primary-bm px-3 d-lg-none rounded-pill" type="button" data-bs-toggle="offcanvas" data-bs-target="#mobileSearchFilterDrawer">
                ...
                <form method="GET" action="{{ route('search') }}">
                    ...
                    <div class="mb-3 form-check">
                        <input class="form-check-input" type="checkbox" name="featured" value="1"
                               id="featuredCheckSearchDesktop" {{ request('featured') ? 'checked' : '' }} onchange="this.form.submit()">
                        <label class="form-check-label small fw-700 text-dark" for="featuredCheckSearchDesktop">⭐ Featured Deals Only</label>
                    </div>
...
<div class="offcanvas offcanvas-bottom rounded-top-4 d-lg-none" tabindex="-1" id="mobileSearchFilterDrawer" style="height: 80vh; max-height: 580px;">
    <div class="offcanvas-header border-bottom py-3">
        <h6 class="offcanvas-title fw-800 text-dark"><i class="bi bi-sliders me-2 text-primary-bm"></i>Filter & Sort Search</h6>
    ...
    <div class="offcanvas-body p-4">
        <form method="GET" action="{{ route('search') }}">
            ...
            <div class="mb-4 form-check">
                <input class="form-check-input" type="checkbox" name="featured" value="1"
                       id="featuredCheckSearchMobile" {{ request('featured') ? 'checked' : '' }}>
                <label class="form-check-label small fw-700 text-dark" for="featuredCheckSearchMobile">⭐ Featured Deals Only</label>
            </div>

            <div class="d-flex gap-2">
                <button type="submit" class="btn btn-primary-bm flex-grow-1 py-3 fw-800">Apply Filters</button>
                <a href="{{ route('search', ['q' => $q]) }}" class="btn btn-outline-secondary rounded-pill px-4 py-3 fw-700">Clear</a>
            </div>
        </form>
    </div>
</div>
